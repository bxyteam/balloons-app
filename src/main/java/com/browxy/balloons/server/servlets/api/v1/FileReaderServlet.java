  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      String fullPath = path == null || path.trim().isEmpty()
          ? Application.getInstance().getBalloonWebConfig().getBasePath() + File.separator + file
          : Application.getInstance().getBalloonWebConfig().getBasePath() + File.separator + path
              + File.separator + file;
